...
void BreadboardSketchWidget::addDefaultParts() {
	...
	m_addedDefaultPart = addItem(refModel()->retrieveModelPart(ModuleIDNames::FullPlusBreadboardModuleIDName), defaultViewLayerSpec(), BaseCommand::CrossView, viewGeometry, newID, -1, NULL);
