...
protected:
    ...
    bool route(Grid * grid, std::priority_queue<GridPoint> & pq, Nearest & nearest);
    bool expand(GridPoint &, Grid * grid, std::priority_queue<GridPoint> & pq, Nearest & nearest);
